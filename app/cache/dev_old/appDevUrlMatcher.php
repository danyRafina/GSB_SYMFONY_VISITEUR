    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/consultationFrais')) {
            ...
            if ($pathinfo === '/consultationFraisType') {
                return array (  '_controller' => 'Ahe\\gsbBundle\\Controller\\FraisVisiteursController::consulterFraisTypeAction',  '_route' => 'gsb_consultation_frais_type',);
            }
        ...
        if (0 === strpos($pathinfo, '/modFhF')) {
            // gsb_visiteurs_mod_FhF
            if (preg_match('#^/modFhF/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'gsb_visiteurs_mod_FhF')), array (  '__controller' => 'AheGsbBundle:FraisVisiteurs:modFHF',));
            }
